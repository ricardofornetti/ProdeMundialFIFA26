...
import { saveCloudGroup, getUserCloudGroups, deleteCloudGroup } from '../services/firebaseService';
            ...
            <div className="space-y-8">
              ...
              <div className="pt-4 flex flex-col gap-3">
                <button 
                  ...
                  className="w-full py-2 bg-slate-100 dark:bg-slate-700 text-slate-800 dark:text-white font-black text-[10px] rounded-xl uppercase tracking-widest hover:bg-slate-200 dark:hover:bg-slate-600 transition-all flex items-center justify-center gap-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4"/></svg>
                  Invitar más miembros directamente
                </button>
                ...
                <button 
                  ...
                  className="w-full py-2 bg-indigo-600 hover:bg-indigo-700 text-white dark:bg-indigo-600 dark:hover:bg-indigo-700 font-black text-[10px] uppercase tracking-widest rounded-xl transition-all hover:scale-[1.03] active:scale-95 flex items-center justify-center gap-2 shadow-lg shadow-indigo-600/10 hover:shadow-indigo-500/30"
                >
                  <svg className="w-3.5 h-3.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-4 4 4 4 0 014-4zM3 20a6 6 0 0112 0v1H3z"/>
                  </svg>
                  <span>{copySuccess ? '¡Enlace de Copiado!' : 'invitar amigos'}</span>
                </button>
                ...
                <button 
                  ...
                  className="w-full py-2 bg-indigo-600 hover:bg-indigo-700 text-white dark:bg-indigo-600 dark:hover:bg-indigo-700 font-black text-[10px] uppercase tracking-widest rounded-xl transition-all hover:scale-[1.03] active:scale-95 flex items-center justify-center gap-2 shadow-lg shadow-indigo-600/10 hover:shadow-indigo-500/30"
                >
                  <svg className="w-3.5 h-3.5 group-hover:rotate-12 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="3">
                    <path d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                  </svg>
                  <span>VER RANKING DEL GRUPO</span>
                </button>
                    ...
                    <div className="pt-2">
                      {!isConfirmingDelete ? (
                        <button 
                          ...
                          className="w-full py-2 bg-red-600 hover:bg-red-700 text-white dark:bg-red-600 dark:hover:bg-red-700 font-black text-[10px] uppercase tracking-widest rounded-xl transition-all hover:scale-[1.03] active:scale-95 flex items-center justify-center gap-2 shadow-lg shadow-red-600/10 hover:shadow-red-500/30"
                        >
                        ...
                        <div className="bg-red-50 dark:bg-red-950/20 p-4 rounded-xl border border-red-200 dark:border-red-900/50 flex flex-col gap-2">
