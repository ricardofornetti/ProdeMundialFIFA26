      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12 gap-6 border-b-4 border-black dark:border-white pb-6">
        <div>
          {onBack && (
            <button 
              onClick={onBack}
              className="flex items-center gap-3 text-white font-black text-xs sm:text-sm uppercase tracking-widest bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-600 dark:hover:bg-indigo-700 px-5 py-3 rounded-2xl transition-all active:scale-95 shadow-lg shadow-indigo-600/10 hover:shadow-indigo-500/30 mb-6"
            >
